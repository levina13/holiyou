                  ...
                  <div class="mb-3 mb-sm-0">
                      <div class="row">
                          <div class="col-12 col-lg-6 d-flex">
                              <div class="fs-5 fw-normal justify-content-center align-self-center"><i class="fas fa-igloo"></i> Tambah Objek Wisata</div>
                          </div>
              ...
              <div class="row">
                  <div class="col-12 mb-3">
                      <div>
                          ...
                          <input class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" type="text" placeholder="Nama Objek Wisata" value="{{ old('nama') }}" required>
                          @error('nama')
              ...
              <div class="row align-items-center">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      <div class="input-group">
                          ...
                          <input class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" type="text" placeholder="Harga" value="{{ old('harga') }}" required>
                          @error('harga')
                          <p class="text text-danger">{{ $message }}</p>
                          @enderror
                      </div>
                      ...
                      <div class="row">
                          <div class="col-sm-8 mb-3">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="alamat" id="alamat" type="text" placeholder="Alamat" value="{{ old('alamat') }}" required>
                                  @error('alamat')
                                  <p class="text text-danger">{{ $message }}</p>
                                  @enderror
                              </div>
                      ...
                      <div class="row">
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input class="form-control @error('latitude_Y') is-invalid @enderror" name="latitude_Y" id="latitude_Y" type="text" placeholder="Latitude" value="{{ old('latitude_Y') }}" required>
                              </div>
                              @error('latitude_Y')
                              <p class="text text-danger">{{ $message }}</p>
                              @enderror
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input class="form-control @error('longitude_X') is-invalid @enderror" name="longitude_X" id="longitude_X" type="text" placeholder="Longitude" value="{{ old('longitude_X') }}" required>
                              </div>
                              @error('longitude_X')
                              <p class="text text-danger">{{ $message }}</p>
                              @enderror
...
@section('layout_script')
    <script>
        var map = L.map('map-box').setView([-7.9754989, 112.645687], 11);
        var marker;
        ...
        @if (old('latitude_X') != null)
            $('#latitude_Y').trigger('change');
        @endif
    </script>
    <script>
        @if (old('kecamatan') != null)
            $("#kecamatan").val({{ old('kecamatan') }}).change();
        @endif
        @if (old('jenis_wisata') != null)
